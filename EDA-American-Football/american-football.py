...
st.title('アメリカンフットボール Player Stats')

st.markdown("""
NFLプレイヤーのスタッツを取得して表示するシンプルなアプリです。
* **Python libraries:** base64, pandas, streamlit, numpy, matplotlib, seaborn
* **Data source:** [pro-football-reference.com](https://www.pro-football-reference.com/).com/).
""")
...
if st.button('Intercorrelation Heatmap'):
    ...
    df_selected_team.to_csv('EDA-American-Football/output.csv', index=False)
    df = pd.read_csv('EDA-American-Football/output.csv')
